...
@TeleOp(name = "RED CLOSE Tele (3) - Regionals", group = "0_Primary")
public class RedCloseTurretAndShooter extends LinearOpMode {
    ...
    private TurretAiming.Alliance currentAlliance = TurretAiming.Alliance.RED;
     ...
     */
    private static final Pose GATE_POSE_1 = new Pose(124.5114, 63.4405, Math.toRadians(19));
    private static final Pose GATE_POSE_2 = new Pose(125.1807, 54.771,  Math.toRadians(20));
